    ...
    <div className="landing-page">
      ...
      <section className="hero-section">
        <div className="hero-text">
          ...
          <button className="btn" onClick={goToReport}>
            Get Your Report
          </button>
        </div>
        ...
        <div className="image-quote-pair">
          ...
          <div className="quote-content">
            ...
            <p>
              ...
              insight you'd expect from a private banking relationship,
              available 24/7.
            </p>
          </div>
        </div>
      ...
      <section className="call-to-action">
        ...
        <p>
          Banker Expert is the easiest way to understand your crypto portfolio.
